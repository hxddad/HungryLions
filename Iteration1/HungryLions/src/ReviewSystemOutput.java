...
class ReviewSystem {
    ...
    public ReviewSystem(String username, String reviewWords, int foodQuality, int service, int atmosphere, int valueForMoney,int howmanyTimesGone,int howManyFoodItemsEaten) {
