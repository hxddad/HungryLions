...
class ReviewSystemOutputTest {
	...
	public void testSubmitValidReview() throws SubmissionException {
		...
		func = new ReviewSystemFunctions();
		 ReviewSystem review = new ReviewSystem("Ryuga", "Good food and kind of okay noodles", 5, 5, 4, 4, 2, 3);
		int expected = 1;
  ...
  @Test
	...
	ReviewSystem review = new ReviewSystem("User", "Review text", 6, 5, 4, -7, 1, 2);
  ...
  public void testWordLimitExceeded() {
      ...
      ReviewSystem ReviewToolong = new ReviewSystem("jeff chan", textexceedswordlimit, 4, 4, 4, 4, 1, 5);
  ...
  public void testFlaggedContentSubmission() {
      ...
      ReviewSystem flagged = new ReviewSystem("UserFlagged", "damn this place bad", 3, 3, 3, 3, 2, 2);
  ...
  public void testValidLowerBoundaryRatings() throws SubmissionException {
      ReviewSystem toolow = new ReviewSystem("blazer", "hated it ", -1, 1, 1, -1, 1, -1);
      assertThrows(SubmissionException.class, () -> func.submitReview(toolow));
  }

  @Test
  public void testInvalidTimesGone() {
      ReviewSystem invalidnumtoohigh = new ReviewSystem("blaster", "loved it ", 4, 4, 4, 6, -1, 3);
